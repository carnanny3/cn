...
class _AiChatScreenState extends State<AiChatScreen> {
    ...
    try {
      ...
      setState(() {
        _messages.add(AiMessage(
          role: 'assistant',
          content: l10n.aiChatConnectionError,
        ));
        _sending = false;
      });
    }
  ...
  Widget build(BuildContext context) {
    ...
    final suggestedPrompts = [
      l10n.aiChatSuggestedServiceDue,
      l10n.aiChatSuggestedInsuranceActive,
      l10n.aiChatSuggestedInspectionReport,
    ];
    return Scaffold(
      extendBodyBehindAppBar: true,
      appBar: AppBar(backgroundColor: Colors.transparent, title: Text(l10n.aiChatTitle)),
                    ...
                    ? Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(l10n.aiChatEmptyTitle, style: Theme.of(context).textTheme.titleLarge),
                            const SizedBox(height: 16),
                            Wrap(
                              spacing: 8,
                              runSpacing: 8,
